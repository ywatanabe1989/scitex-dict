...
# (project=scitex-dict, owner=ywatanabe1989, repo=scitex-dict,
...
TMPDIR="/tmp/publish-scitex_dict-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-dict dist/* uploaded to PyPI via manual OIDC trusted publishing"
