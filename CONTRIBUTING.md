...
- Search [existing issues](https://github.com/ywatanabe1989/scitex-dict/issues)
  before opening a new one.
- Include a minimal reproducible example when reporting bugs.
- Specify your Python version, OS, and `scitex-dict` version.

## Development Setup

```bash
git clone git@github.com:ywatanabe1989/scitex-dict.git
cd scitex-dict
pip install -e ".[dev]"
```
