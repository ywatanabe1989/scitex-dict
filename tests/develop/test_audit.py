...
def test_audit_all_for_package_runs_without_raising():
    # Arrange
    from scitex_dev.testing import audit_all_for_package

    # Act
    audit_all_for_package("scitex-dict")

    # Assert
    assert True  # audit_all_for_package raises on violations; reaching here = clean
